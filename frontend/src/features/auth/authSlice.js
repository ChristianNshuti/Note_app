...
export const register = createAsyncThunk('auth/register', async({username,email,password,role}) => {
    const res = await axios.post(`${API_URL}/register`,{username,email,password,role},{withCredentials:true});
    return res.data;
});
